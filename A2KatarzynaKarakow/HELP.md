...
* [Spring Security](https://docs.spring.io/spring-boot/docs/2.4.6/reference/htmlsingle/#boot-features-security)
* [Thymeleaf](https://docs.spring.io/spring-boot/docs/2.4.6/reference/htmlsingle/#boot-features-spring-mvc-template-engines)
